...
const tileData = [
    {
        img: 'https://images.pexels.com/photos/1456262/pexels-photo-1456262.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500',
...
export default function SecondDealSlider() {
    const classes = useStyles();

    return (
        <div className={classes.root}>
            <div className={classes.foodtitle}>
               <h3>Upto 70% Off</h3><LocalOfferIcon className={classes.icon}/> 
            </div>
